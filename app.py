        ...
        with tips_placeholder.container():
            ...
            st.markdown(
                ...
                <div class="tips-box primary">
                    ...
                    <ul>
                        <li><strong>1. เตรียมไฟล์:</strong> อัปโหลดผล CBC, blood chemistry หรือ blood gas จากโรงพยาบาลหรือห้องแล็บ (PNG, JPG, JPEG หรือรูปถ่ายมือถือก็ได้).</li>
                        <li><strong>2. ให้ AI วิเคราะห์/สรุป:</strong> Crystal Blood AI อ่านทุกพาเนล ระบุค่าสูง/ต่ำ และสร้างสรุปที่ช่วยบรีฟให้ทีมรักษา.</li>
